...
insert into member( userid, passwd, ssn, username, post, addr1, addr2, phone, email, wishlist )
values ('pts', '1234', '123123-1231235', '테스터', 13161, '전북 전주시 덕진구 전북동', '우성아프트 120/1805', '01012341235', 'test@test.com', null);
commit;
...
(
  ...
  addr1 varchar2(500) not null, -- 신 주소표기, 도로명주소
  addr2 varchar2(500) not null, -- 신 주소표기, 건물명
